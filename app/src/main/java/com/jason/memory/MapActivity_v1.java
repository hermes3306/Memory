...
public class MapActivity_v1 extends AppCompatActivity implements OnMapReadyCallback {
    private GoogleMap mMap;
    private DatabaseHelper dbHelper;
    private int circleSizeInSquareMeters = 100; // Default size, can be changed in settings
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        circleSizeInSquareMeters = prefs.getInt("circle_size", 100);
